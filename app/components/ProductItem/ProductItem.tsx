...
const ProductItem: React.FC<ProductType> = memo(({ item }) => {
 ...
 return (
  <div className="flex flex-row flex-wrap p-6 m-8 max-md:p-0 shadow-slate-300 shadow-2xl rounded-md">
   <p className="w-[680px] h-[380px] flex mx-auto shadow-2xl max-md:max-w-[400px] max-md:max-h-[250px]">
    <Image
   ...
   <div className="flex flex-col mx-auto my-auto justify-center min-w-[360px] max-md:p-6">
    <ul className="text-center flex flex-col space-y-4 max-md:space-y-1">
     <li className="pb-8 font-bold text-2xl max-md:text-xl pt-6 max-md:pb-20">{item.name}</li>
     <li>
